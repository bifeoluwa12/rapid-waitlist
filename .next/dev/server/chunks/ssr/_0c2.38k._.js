module.exports = [
"[project]/src/app/data:04975e [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$04975e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:04975e [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
function Home() {
    ...
    async function handleSubmit(formData) {
        setStatus("loading");
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$04975e__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["joinWaitlist"])(formData);
        if (result?.success) {
            setStatus("success");
...
//# sourceMappingURL=_0c2.38k._.js.map